...
$string['accountname'] = 'Nombre de cuenta';
$string['accountname_help'] = 'Cómo es que esta cuenta será identificada por profesores o mánagers (gestores) que configuran los pagos (por ejemplo, en el plugin para inscripción al curso)';
...
$string['gatewaynotfound'] = 'Portal no encontrado';
...
$string['paymentaccount'] = 'Cuenta de pagos';
$string['paymentaccounts'] = 'Cuentas de pagos';
