...
$string['modulename_help'] = 'El módulo de actividad \'simple certificate\' permite al profesor crear certificados personalizados que pueden ser emitidos a los alumnos que han completado los requisitos que ha especificado el profesor.';
